...
function hasScrollbar(){  
    if (elem.clientHeight < elem.scrollHeight) contentRequiredStar.style.right = "1rem";
...
formSubmitButton.onclick = async e => {
    ...
    formSubmitButton.disabled = false;
        ...
        formStatus.textContent = "There was a problem sending your message. Please double check your input and try again!";
        formStatus.classList.add("form-status-error");
        formSubmitButton.textContent = "Submit";
    formSubmitButton.disabled = false;
    }
